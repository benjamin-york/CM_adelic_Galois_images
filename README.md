...
The other file in this repository, `Examples.m`, has explicit examples showing how to run our code and what the results of our computations look like. All times mentioned in this file also come from running `GL2CMAdelicImageCode.m` on the HP EliteBook mentioned above.
